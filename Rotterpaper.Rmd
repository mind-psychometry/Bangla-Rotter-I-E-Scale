...
ggsave("figures/300/Figure1.png",corplot, width = 3.5, height = 3.5, dpi = 300, bg ="white")
...
knitr::include_graphics('figures/300/Figure1.png', dpi =600)
...
ggsave("Figures/300/Figure2.png",factor, width =3.5, height = 7, dpi = 300)
...
knitr::include_graphics('Figures/300/Figure2.png', dpi =600)
...
ggsave("Figures/300/Figure4.png",personfit, width = 3.5, height = 3.5, dpi = 300, bg = "white")
...
knitr::include_graphics('Figures/300/Figure4.png', dpi =600)
```
...
ggsave("Figures/300/Figure6.png",ifc, width = 7, height = 8, dpi = 300, bg = "white")
...
ggsave("Figures/300/Figure5.png", width = 7, height = 7, dpi = 300, bg = "white")
